...
import { useUpdatedProductMutation, useGetProductDetailsQuery } from "../../redux/api/productApi.js";
...
const UpdateProduct = () => {
    ...
    const { name, description, price, category, stock, seller, images } = product;
    const [updateProduct, { isLoading, error, isSuccess }] = useUpdatedProductMutation();
