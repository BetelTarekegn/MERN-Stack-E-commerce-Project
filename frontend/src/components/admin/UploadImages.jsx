...
import { useGetProductDetailsQuery,useUploadProductImagesMutation,useDeleteProductImageMutation} from "../../redux/api/productApi.js";
    ...
    files.forEach((file) => {
      ...
      reader.onload = () => {
        if (reader.readyState === 2) {
          setImagesPreview((oldArray) => [...oldArray, reader.result]);  // Show preview from base64 immediately
          setImages((oldArray) => [...oldArray, reader.result]);         // Save base64 string for upload
        }
      }
          ...
          <form className="shadow rounded bg-body" encType="multipart/form-data" onSubmit={submitHandler}>
            ...
            <div className="mb-3">
              ...
              {uploadedImages?.length > 0 && (<div className="uploaded-images my-4">
               ...
               <button id="register_button" type="submit" className="btn w-100 py-2" disabled={isLoading || isDeleteLoading}>{isLoading ? " Uploading.." : " Upload"}</button>
